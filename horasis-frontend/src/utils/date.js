...
export const dateFormatList = ['DD/MM/YYYY', 'MM/YYYY', 'DD/MM/YY', 'DD-MM-YYYY', 'DD-MM-YY']
...
export function getDateInWordsFormat(dateObj) {
	if (dateObj.getDate() < 10) {
		return MONTHS_SHORT[dateObj.getMonth()] + ' ' + '0' + dateObj.getDate() + ', ' + dateObj.getFullYear()
	}
	return MONTHS_SHORT[dateObj.getMonth()] + ' ' + dateObj.getDate() + ', ' + dateObj.getFullYear()
}
export function getDateInWordsResumeFormat(dateObj) {
	if (dateObj.getDate() < 10) {
		return '0' + dateObj.getDate() + '-' + MONTHS_SHORT[dateObj.getMonth()] + '-' + dateObj.getFullYear()
	}
	return MONTHS_SHORT[dateObj.getMonth()] + ' ' + dateObj.getDate() + ', ' + dateObj.getFullYear()
}
...
export function getDateInFullWordsFormat(dateObj) {
	if (dateObj.getDate() < 10) {
		return MONTHS[dateObj.getMonth()] + ' ' + '0' + dateObj.getDate() + ', ' + dateObj.getFullYear()
	}
	return MONTHS[dateObj.getMonth()] + ' ' + dateObj.getDate() + ', ' + dateObj.getFullYear()
}
export function getDateForAnalyticsFormat(dateObj) {
	if (dateObj.getDate() < 10) {
		return '0' + dateObj.getDate() + '/' + MONTHS_NUM[dateObj.getMonth()] + '/' + dateObj.getFullYear()
	}
	return dateObj.getDate() + '/' + MONTHS_NUM[dateObj.getMonth()] + '/' + dateObj.getFullYear()
}
...
export const setStartTime = (orgDate) => {
	if (orgDate instanceof Date && isFinite(orgDate)) {
		return new Date(orgDate.getFullYear(), orgDate.getMonth(), orgDate.getDate(), 0, 0, 0, 0).getTime()
	} else {
		return null
	}
}
...
export const setEndTime = (orgDate) => {
	if (orgDate instanceof Date && isFinite(orgDate)) {
		return new Date(orgDate.getFullYear(), orgDate.getMonth(), orgDate.getDate(), 23, 59, 59, 0).getTime()
	} else {
		return null
	}
}

export const getMonthsShort = (timestamp) => {

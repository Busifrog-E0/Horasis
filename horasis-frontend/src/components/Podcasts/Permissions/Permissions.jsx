...
const Permissions = ({ permissionType, discussionId, discussion, from = 'settings' }) => {
	...
	const componentContent = {
		CanInviteOthers: {
			...
			Subtitle: 'Which members of this podcast are allowed to invite others?',
		},
		CanPostActivity: {
			Title: 'Upload Permission',
			Subtitle: '	Which members of this podcast are allowed to have upload permission?',
		},
		CanUploadPhoto: {
			Title: 'Group Photos',
			Subtitle: 'Which members of this podcast are allowed to upload albums?',
		},
		CanCreateAlbum: {
			Title: 'Group Albums',
			Subtitle: 'Which members of this podcast are allowed to create albums?',
		},
		CanUploadVideo: {
			Title: 'Upload Video',
			Subtitle: 'Which members of this podcast are allowed to upload videos?',
		},
		IsAdmin: {
			Title: 'Admin',
			Subtitle: 'Which members of this podcast are allowed to admin permissions?',
		},
	}

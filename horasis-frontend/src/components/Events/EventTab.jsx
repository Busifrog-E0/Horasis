    ...
    return (
        <div className="rounded-lg mt-3 overflow-hidden h-full cursor-pointer  flex flex-col" onClick={() => onClick(event.DocId)}>
            ...
            <div className="mt-1 grid grid-cols-7 gap-1 flex-1">
                <div className="col-span-2  bg-system-secondary-bg rounded-lg shadow-lg flex justify-center items-center flex-col">
                ...
                <div className="col-span-5  rounded-lg shadow-lg flex flex-col justify-between bg-system-secondary-bg">

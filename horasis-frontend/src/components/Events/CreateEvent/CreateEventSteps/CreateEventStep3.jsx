...
const CreateEventStep3 = ({ selectedImage, onImageSelect, fileFieldName }) => {
	...
	return (
		<div className='flex flex-col gap-4'>
			<div>
				<input onChange={handleImageChange} ref={fileInputRef} type='file' id='createEventPhotoPicker' className='hidden' />
				...
				<p className='text-brand-gray mt-1 mb-2 text-base'>
					Upload a photo that represents this group. This image will be shown on the main group page and in search results.
				</p>
			</div>
		</div>
	)

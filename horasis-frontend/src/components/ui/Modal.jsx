...
const Header = ({ children }) => {
  return (
    <div className="p-4 flex items-center justify-between bg-system-secondary-bg text-brand-primary  border-system-file-border">
      {children}
    </div>
  )
}

const Body = ({ children,padding=undefined }) => {

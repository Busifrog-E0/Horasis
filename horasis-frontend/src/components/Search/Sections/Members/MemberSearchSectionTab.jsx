...
const MemberSearchSectionTab = ({ lastElement, profile, updateList, whichTime, updatingId, tabName }) => {
	...
	return (
		<>
			<div
				className={`bg-system-secondary-bg`}>
...
export default MemberSearchSectionTab

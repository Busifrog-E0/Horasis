	...
	return (
		<div className='p-5 bg-system-secondary-bg rounded-lg'>
			<div className='flex items-center justify-between gap-2 mb-1'>
				...
				{activitiesData.length > 0 && <img src={arrowfor} alt='' className='h-6 w-6 cursor-pointer' onClick={() => navigate('/Saved')} />}
			...
			<div>
				{isLoading ? (
					...
					<>
						<ActivityListComponent onSaveRemoveCallback={fetch} ShowImage={false} className={`p-4 bg-system-secondary-bg rounded-lg border border-system-file-border relative`} avatarSize='w-8 h-8' titleSize='text-sm' descriptionSize='text-xs' onDelete={onDelete} gapBnTabs={'gap-3'} bordered={true} activitiesData={activitiesData} timeSize='text-xs' iconSize={'4'} />

  ...
  return (
    <div className="bg-system-secondary-bg block lg:hidden border-t border-system-file-border">
      <div className="grid grid-cols-5 gap-3">
        ...
        }} type="button" className="py-2 inline-flex flex-col items-center justify-center px-5 bg-brand-gray-dim">
        ...
        <button onClick={() => {
          OnClickMenu("/Activities")
        }} type="button" className="py-2 inline-flex flex-col items-center justify-center px-5">
          ...
          <span className="text-xs -mb-1 text-system-primary-text ">Activities</span>
        </button>
        <button onClick={() => {
          OnClickMenu("/Events")
        }} type="button" className="py-2 inline-flex flex-col items-center justify-center px-5">
          ...
          <span className="text-xs -mb-1 text-system-primary-text ">Events</span>
        </button>
        <button onClick={() => {
          ...
          <span className="text-xs -mb-1 text-system-primary-text ">Discussions</span>
        </button>
        <button onClick={() => {
          ...
          <span className="text-xs -mb-1 text-system-primary-text ">Connections</span>
        </button>
        <button onClick={() => {
          ...
          <span className="text-xs -mb-1 text-system-primary-text ">Analytics</span>
        </button>
      </div>
